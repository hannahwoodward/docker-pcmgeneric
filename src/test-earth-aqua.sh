MODEL=gcm_64x48x20_phystd_b38x36_seq.e
PLANET_CONFIG=bench_earthslab_64x48x20_b38x36
...
cd $MODELDIR
echo "Compiling PCM"
./makelmdz_fcm -arch local -p std -d 64x48x20 -b 38x36 -j 4 gcm > makelmdz_fcm.out 2>&1
