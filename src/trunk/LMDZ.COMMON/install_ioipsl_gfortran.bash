...
# arch.path file
echo "NETCDF_INCDIR=\"-I$NETCDF_HOME/include -I$NETCDF_HOME/lib64/gfortran/modules\"" > arch-gfortran.path
echo "NETCDF_LIBDIR=\"-L$NETCDF_HOME/lib64\"" >> arch-gfortran.path
